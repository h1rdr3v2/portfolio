...
import {CalendarDays, Sparkles, TrendingUp, User} from "lucide-react"

export const Route = createFileRoute('/blog/')({
  component: BlogPage,
  loader: async () => {
    return await getPaginatedBlogPosts()
  },
})

function BlogPage() {
  const { posts, totalPages, totalPosts } = Route.useLoaderData()
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {posts.length === 0 ? (
          ...
          <>
            {/* Featured Post */}
            {featuredPost && (
              <Link to="/blog/$slug" params={{ slug: featuredPost.slug }} className="block mb-12 animate-fadeInUp animation-delay-200">
